...
2. Com o switch **ligado**, envie algo como:
   ...
   -
   - Prompts contidos nos links abaixo podem ser usados:
   https://evaluate-lakera.gitbook.io/guide/z3dPFEm7NPP9msWvE6j1/evaluation-guide/threat-intelligence/data-data-data
Exemplo (https://huggingface.co/datasets/rubend18/ChatGPT-Jailbreak-Prompts/viewer/default/train?row=60):
